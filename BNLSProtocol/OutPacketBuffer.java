...
public class OutPacketBuffer extends Buffer {
	...
	public String getStringBuffer() {// Unused?
		// int s=size();
		// return (char)(byte)((s+3 >> 0) & 0x000000FF) + (char)(byte)((s+3 >> 8) &
		// 0x000000FF) + String.valueOf(super.getBuffer());
	...
	/**
	 * Overrides the "Buffer" method, returning the packet ID/length and the data
	 *
