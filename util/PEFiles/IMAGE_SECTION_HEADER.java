...
public class IMAGE_SECTION_HEADER extends HEADER {
	 ...
	 * UCHAR Name[IMAGE_SIZEOF_SHORT_NAME]; : 0x00* union { * ULONG PhysicalAddress;
	 * * ULONG VirtualSize; * } Misc; : 0x04* ULONG VirtualAddress; : 0x08* ULONG
	 * SizeOfRawData; : 0x0c* ULONG PointerToRawData; : 0x10* ULONG
	 * PointerToRelocations; : 0x14* ULONG PointerToLinenumbers; : 0x18* USHORT
	 * NumberOfRelocations; : 0x20* USHORT NumberOfLinenumbers; : 0x24* ULONG
