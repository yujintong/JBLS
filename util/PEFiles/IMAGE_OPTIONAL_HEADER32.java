...
public class IMAGE_OPTIONAL_HEADER32 extends HEADER {
	/********************************************************************************
	 * typedef struct _IMAGE_OPTIONAL_HEADER { * // Standard fields. * WORD Magic; :
	 * 0x00* BYTE MajorLinkerVersion; : 0x02* BYTE MinorLinkerVersion; : 0x03* DWORD
	 * SizeOfCode; : 0x04* DWORD SizeOfInitializedData; : 0x08* DWORD
	 * SizeOfUninitializedData; : 0x0c* DWORD AddressOfEntryPoint; : 0x10* DWORD
	 * BaseOfCode; : 0x14* DWORD BaseOfData; : 0x18* // NT additional fields. *
	 * DWORD ImageBase; : 0x1c* DWORD SectionAlignment; : 0x20* DWORD FileAlignment;
	 * : 0x24* WORD MajorOperatingSystemVersion; : 0x28* WORD
	 ...
	 * SizeOfHeapReserve; : 0x50* DWORD SizeOfHeapCommit; : 0x54* DWORD LoaderFlags;
	 * : 0x58* DWORD NumberOfRvaAndSizes; : 0x5c* IMAGE_DATA_DIRECTORY
	...
	public void print(PrintStream out, int indent) {
		...
		out.println(
				i + "  Operating System Version: " + MajorOperatingSystemVersion + "." + MinorOperatingSystemVersion);
