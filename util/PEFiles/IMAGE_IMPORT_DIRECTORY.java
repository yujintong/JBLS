...
public class IMAGE_IMPORT_DIRECTORY extends HEADER {
	/**********************************************
	 * typedef struct _IMAGE_IMPORT_DIRECTORY { * DWORD AddressOfImportLookupTable;
	 * : 0x00* DWORD TimeDateStamp; : 0x04* DWORD ForwarderChain; : 0x08* DWORD
	 * AddressOfNames; : 0x0c* DWORD AddressOfImportTable; : 0x10* } *
	 **********************************************/
