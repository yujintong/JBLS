...
public final class Constants {
	...
	public static String[] prods = { "STAR", "SEXP", "W2BN", "D2DV", "D2XP", "JSTR", "WAR3", "W3XP", "DRTL", "DSHR",
			"SSHR" };
	public static String[][] IX86files = { { "IX86/STAR/", "Starcraft.exe", "Storm.dll", "Battle.snp", "STAR.bin" },
	...
	// public static String build="Build V3.0 BotNet Admin, Lockdown, Legacy
	// Clients.(07-07-07)";
	// public static String build="Build V2.9 Remote admin, extended admin commands
	// w/ JSTR support.(01/18/06)";
