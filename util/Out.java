...
public class Out {
	...
	/**
	 * Displays errors //@param source: source of the info //@param text: text to
	 * show
	 */
	...
	/**
	 * Displays debug information, if wanted //@param source - source of the info
	...
	/**
	 * Sets the output stream for the information to be displayed to. Can be set to
	 * system.out, admin output stream, file logging, etc..
	 * 
	 * @param s
	 ...
	 *
	 * @author Ron -Fool Change: Moved in here instead of own TimeStamp Class Don't
